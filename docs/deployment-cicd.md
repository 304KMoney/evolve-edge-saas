...
- `PRODUCTION_STRIPE_PRICE_STARTER_ANNUAL`
- `PRODUCTION_STRIPE_PRICE_SCALE_ANNUAL`
- `PRODUCTION_STRIPE_PRICE_ENTERPRISE_ANNUAL`
- `PRODUCTION_STRIPE_PRODUCT_STARTER`
- `PRODUCTION_STRIPE_PRODUCT_SCALE`
- `PRODUCTION_STRIPE_PRODUCT_ENTERPRISE`
...
- `PRODUCTION_REPORT_DOWNLOAD_SIGNING_SECRET`
- `PRODUCTION_EMAIL_FROM_ADDRESS`
- `PRODUCTION_RESEND_API_KEY`
- `PRODUCTION_RESEND_WEBHOOK_SIGNING_SECRET`
- `PRODUCTION_NOTIFICATION_DISPATCH_SECRET`
- `PRODUCTION_CRON_SECRET`
- `PRODUCTION_OPS_READINESS_SECRET`
- `PRODUCTION_PUBLIC_INTAKE_SHARED_SECRET`
...
- `PRODUCTION_N8N_CALLBACK_SECRET` or `PRODUCTION_N8N_CALLBACK_SHARED_SECRET`
...
The production env validation profile now checks the canonical first-customer
launch contract, including Stripe price/product envs, delivery/report auth
secrets, and that `N8N_WORKFLOW_DESTINATIONS` contains a valid
